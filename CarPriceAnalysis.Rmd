...
Another pain that Geely Auto may find as they explore what features impact the price of the car, is that some features compromise the performance of others as they are added to the vehicle model. For example, we found that in our research, features such as the weight of the car and the horsepower may negatively impact the fuel efficiency of the vehicle. Different consumers may have different interpretations of what they value and are willing to spend on a car based on their needs and preferences. These features often interact together to impact price, so it is important to consider their effects together as opposed to isolated ones.
 


## 4. Client Gains

From moving from China to the US, one gain that Geely can expect to see is increased market share in the US market. This will allow a larger customer base to become more knowledgeable about Geely and its products, thus making their company more available and accessible to new consumers, and leading to new sales opportunities.
